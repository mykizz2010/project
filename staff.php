...
if (isset($_GET['delete'])){
  $id = $_GET['delete'];
  $delete=mysqli_query($db, "DELETE from staff where id='$id' limit 1");
}
                      ...
                      <table class="table table-bordered table-responsive">
                        ...
                        <?php while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){ ?>
                          <tr>
                            ...
                            <td><a href="staff-view.php?id=<?php echo $row['id'];?>"> <img src="icons/eye-view.png" style="width: 20px; height: 20px;"></a></td>
                            <td><a href="edit.php?id=<?php echo $row['id']; ?>"> <img src="icons/edit-icons.jpg" style="width: 20px; height: 20px;"></a></td>
                            <td><a onclick="return confirm('Sure to delete?')" href="staff.php?delete=<?php echo $row['id'];?>"><img src="icons/delete.png" style="width: 20px; height: 25px;"></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                      </table>
