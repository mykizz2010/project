...
$sql = "SELECT s.name, a.date, a.time_in, a.time_out FROM staff AS s INNER JOIN attendance AS a ON s.id = a.staff_id";
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4"> Today Attendance</h3>
                    </div>
                    <div class="card-body">
