        ...
        <div class="form-holder has-shadow">
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
	            	<p style="color: #313d53; padding-top: 10px; padding-left: 230px; font-style: italic; font-weight: 200px;">ADMIN LOGIN!!
	            	</p>
              <div class="info d-flex">
                  ...
                  <form id="login-form" method="post" action="">
                    ...
                    </div><button type="login" id="login" name="submit" class="btn btn-success">Login</button>
